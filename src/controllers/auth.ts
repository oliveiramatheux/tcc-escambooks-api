...
const authVerifyEmailController = asyncHandler(
  async (request: Request, response: Response) => {
...
const authSendEmailVerifyController = asyncHandler(
  async (request: Request, response: Response) => {
...
const authSendPasswordResetController = asyncHandler(
  async (request: Request, response: Response) => {
    const { email } = request.body
...
const authResetPasswordTokenController = asyncHandler(
  async (request: Request, response: Response) => {
    const { email, resetToken, newPassword } = request.body
    const user = await authResetPasswordTokenService({
      email,
      resetToken,
      newPassword
    })
...
const authResetPasswordController = asyncHandler(
  async (request: Request, response: Response) => {
    ...
    const user = await authResetPasswordService(
